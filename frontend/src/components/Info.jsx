        ...
        <div className={display + ` h-auto`} data-aos="fade-up">
            ...
            <div className="pt-20 bg-bottom w-screen h-800 bg-[url('../public/transparentBg.png')] bg-cover" data-aos="zoom-in">
                ...
                <div className='grid grid-cols-4 pl-80 mt-16'>
                    <span data-aos="slide-left"><center><img src="https://about.canva.com/wp-content/uploads/sites/8/2019/03/pink.png" className='rounded-full w-40 h-40 mb-3' /><p className='text-xl font-regular'>Richard</p><p className='text-xl font-extrabold'>Shuai</p></center></span>
                    <span data-aos="slide-up"><center><img src="https://about.canva.com/wp-content/uploads/sites/8/2019/03/pink.png" className='rounded-full w-40 h-40 mb-3' /><p className='text-xl font-regular'>Carolyn</p><p className='text-xl font-extrabold'>Zhang</p></center></span>
                    <span data-aos="slide-right"><center><img src="https://about.canva.com/wp-content/uploads/sites/8/2019/03/pink.png" className='rounded-full w-40 h-40 mb-3' /><p className='text-xl font-regular'>Emma</p><p className='text-xl font-extrabold'>Huang</p></center></span>
                    <span data-aos="slide-down"><center><img src="https://about.canva.com/wp-content/uploads/sites/8/2019/03/pink.png" className='rounded-full w-40 h-40 mb-3' /><p className='text-xl font-regular'>Angela</p><p className='text-xl font-extrabold'>Xu</p></center></span>
